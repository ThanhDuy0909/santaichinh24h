...
<head>
    ...
    <meta property='og:url' content='http://santaichinh24h.vn/post-create' />
                            ...
                            <div class="logined d-flex">
                                <div class="dropdown">
                                    <a class="text-primary dropdown-toggle" href="#" role="button" id="dropdownMenuInfo"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Duy</a>
                    ...
                    <div class="tt-header-holder">
                        <div class="tt-col-obj tt-obj-options">
                            <div class="block-center d-flex align-items-center justify-content-center">
                                ...
                                <div class="post px-2" style="display:none;"><a href="/post-create">Đăng tin</a>
                                </div>
        ...
        <div class="tt-breadcrumb">
            <div class="container">
                <ul>
                    ...
                    <li><a href="javascript:void(0)">Đăng tin</a></li>
                </ul>
            </div>
        </div>
        <div class="container fluid">
            <div class="pt-3 pb-4">
                <div class="title">
                    <h3 class="text-center">Đăng tin</h3>
                </div>
                <div class="wrap-item wrap-item d-flex justify-content-around flex-wrap">
                    <div class="item">
                        <a class="btn btn-primary" href="/post_cic">Đăng tin CIC</a>
                    </div>
                    <div class="item">
                        <a class="btn btn-primary" href="/post_data">Đăng tin Data</a>
                    </div>
                    <div class="item">
                        <a class="btn btn-primary" href="/post_tinchovay">Đăng tin cho vay</a>
                    </div>
                    {{-- <div class="item">
                        <a class="btn btn-primary" href="#">Đăng tin tuyển dụng</a>
                    </div> --}}
                </div>
            </div>
        </div>
