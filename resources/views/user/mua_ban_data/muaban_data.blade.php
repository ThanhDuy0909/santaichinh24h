...
<head>
    ...
    <meta property='og:url' content='http://santaichinh24h.vn/post-data-trading-filter' />
            ...
            <div class="row">
                <div class="col-md-9">
                    <form id="search_employ" class="bg_employ mb-4">
                        <div class="form-row">
                            <div class="col-md-5">
                                <label for="inputGroupSelect02" class="col-form-label">Data theo loại: </label>
                            ...
                            <div class="col-md-7">
                                <label for="inputEmail3" class="col-form-label">Tỉnh thành: </label>
                                <div class="row">
                                    <div class="col-md-9">
                ...
                <div class="col-md-3">
                    <div class="mb-2">
                        <a class="buysell-data justify-content-between d-flex align-items-center"
                            href="/post_data"> Đăng Tin Mua - Bán Data <i class="fa fa-database "
