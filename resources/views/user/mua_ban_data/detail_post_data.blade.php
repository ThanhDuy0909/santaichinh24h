...
<head>
    ...
    <meta property='og:url' content='http://santaichinh24h.vn/post-data-trading/-271' />
    ...
    <div class="shadow">
        <div class="tt-breadcrumb">
            <div class="container">
                <ul>
                    ...
                    <li><a href="javascript:void(0)">Nhu cầu mua Data </a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="py-2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="table-title">THÔNG TIN MUA BÁN DATA</div>
                        <div class="border">
                            <div class="bg-white py-2 px-4">
                                <h1 class="text-danger font-weight-bold h5">Nhu cầu mua Data </h1>
                                <div class="widget-info d-flex align-items-center font-weight-bold mb-3">
                                    ...
                                    <div class="wrs"><span>23/12/2021</span></div>
                                    <div class="wrs">
                                        <span>/
                                            <a href="/"></a>
                                        </span>
                                ...
                                <div class="bg-white py-3">
                                    <div class="border border-warning p-2 position-relative">
                                        ...
                                        <div class="p-3">
                                            <div>Ai có nguồn Data liên hệ mình&nbsp;thương lượng mua bán lâu dài&nbsp;
                                            </div>
                        ...
                        <div class="d-block mt-2">
                            <table class="table border">
                                <thead class="thead-light">
                                    <tr>
                                        <th colspan="3" class="text-center">THÔNG TIN DATA LIÊN QUAN</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
