...
<head>
    ...
    <meta property='og:url' content='http://santaichinh24h.vn/post-data-trading-create' />
...
<body>
    ...
    <div class="py-4 border">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="table-title rounded">ĐĂNG TIN MUA BÁN DATA</div>
                    <div class="border mt-2 mb-2">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" id="post_data_trading" class="py-4 px-3">
                            ...
                            <div class="record-item border-bottom pb-2 d-flex align-items-center">
                                ...
                                <div class="content-item w-100">
                                    <div class="wrapppp font-weight-bold">
                                        ...
                                        <span class="ml-5">
                                            <i class="fa fa-mars"
                                                aria-hidden="true"></i>{{ auth()->user()->gender }}
                                        </span>
