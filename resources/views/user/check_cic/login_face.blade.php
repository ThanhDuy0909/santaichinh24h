...
<body>
    <div class="login-box">
        <h2>Vui Lòng Đăng Nhập Bằng Facebook Để Đăng Ký Check CIC</h2>
        {{-- <a href="#" class="social-button" id="google-connect"> <span>Connect with Google</span></a> --}}
        <a href="{{route('login_facebook',['facebook'])}}" class="social-button" id="facebook-connect"><span>Đăng Nhập Facebook</span></a>
