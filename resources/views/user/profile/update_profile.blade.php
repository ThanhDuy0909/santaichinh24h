...
<body>
    ...
    <div class="py-4 border">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-title">THAY ĐỔI THÔNG TIN NGƯỜI DÙNG</div>
                    <div class="border mt-2 mb-2">
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                <form class="py-4" action="{{'update_profile'}}" method="post">
                                    @csrf
                                    <table class="table table-create border">
                                        <thead class="thead-light">
                                            ...
                                            <tr>
                                                <th colspan="3" class="text-center">ĐỔI THÔNG TIN CHO TÀI KHOẢN <i class="fa fa-user-circle" aria-hidden="true"></i> {{auth()->user()->username}}</th>
                                            </tr>
                                            ...
                                            <tr class="d-flex align-items-center">
                                                ...
                                                <td class="col-md-8">
                                                    <input type="name" id="password" name="name"
                                                        class="form-control" require value="{{auth()->user()->name}}"
                                                        minlength="6" >
                                                </td>
                                            </tr>
                                            <tr class="d-flex align-items-center">
                                                ...
                                                <td class="col-md-8">
                                                    ...
                                                    require value="{{auth()->user()->email}}" class="form-control">
                                                </td>
                                            </tr>
                                            <tr class="d-flex align-items-center">
                                                ...
                                                <td class="col-md-8">
                                                    ...
                                                    require value="{{auth()->user()->phone}}" class="form-control">
                                                </td>
                                            </tr>
                                            <tr class="d-flex align-items-center">
                                                ...
                                                <td class="col-md-8">
                                                    ...
                                                    require value="{{auth()->user()->address}}" class="form-control">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="input-div one">
                                                        ...
                                                        <input type="radio" id="khac" name="gender" value="2">
                                    ...
                                    <div class="mt-3">
                                        <div class="text-center">
                                            <div class="item">
                                                <input type="hidden" name="action" value="resert">
                                                <button class="btn btn-primary font-weight-bold" type="submit">Thay đổi
                                                </button>
                                            </div>
                                        </div>
                                    </div>
