...
<body class="loaded">
                    ...
                    <div class="tt-mobile-parent-menu">
                        ...
                        <a class="tt-logo tt-logo-alignment" href="/">
                            <img src="//santaichinh24h.vn/files/images/logo/logo-ff.png" height="40px" alt="Logo"
                                class="loading" data-was-processed="true"></a></div>
            ...
            <div class="container">
                <div class="flex-roww">
                    ...
                    <div class="tt-col-obj tt-obj-logo">
                        <!-- logo -->
                        <a class="tt-logo tt-logo-alignment" href="/">
                            <img src="//santaichinh24h.vn/files/images/logo/logo-ff.png" alt="Logo" class="loading"
    ...
    <div id="tt-pageContent" class="border-top pb-4">
        <div class="container-indent">
            <div class="container">
                <h1 class="tt-title-subpages noborder">BẠN CÓ TÀI KHOẢN CHƯA?</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="tt-item">
                                ...
                                Nếu như bạn có tài khoản, hãy đăng nhập vào.
                                <div class="form-default form-top">
                                    <form action ="{{'login'}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label for="loginInputName">NHẬP TÀI KHOẢN</label>
                                            <div class="tt-required">* Yêu cầu bắt buộc</div>
                                            <input type="text" name="username" class="form-control" id="loginInputName"
                                                placeholder="Nhập tài khoản">
                                        </div>
                                        <div class="form-group">
                                            <label for="loginInputEmail">MẬT KHẨU *</label>
                                            <input type="password" name="password" class="form-control"
                                                id="loginInputEmail" placeholder="Nhập mật khẩu">
                                        </div>
                                        <div class="row">
        ...
        <div class="py-3"
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="logo-footer">
                                <a href="#"><img src="//santaichinh24h.vn/files/images/logo/logo-ff.png" class="loading"
                                        data-was-processed="true"></a>
                            </div>
                            ...
                            <div class="contact-footinfo">
                                <address>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3"><i class="fa fa-phone-square" aria-hidden="true"></i></div>
            ...
            <div class="container address-footer">
                <div class="wrapp py-4">
                    <div class="headquarter"><a href="#">Trụ sở chính: Tầng 6, Tòa nhà Pasteur, 139 Pasteur, Phường 6,
