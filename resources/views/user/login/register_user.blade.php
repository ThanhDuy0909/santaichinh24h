...
<body>
                ...
                <div class="tt-header-row">
                    ...
                    {{-- <div class="tt-mobile-parent-search tt-parent-box">
                        <div class="block-right">
                            ...
                            <div class="sign-up">
                                <span><img
                                        src="//santaichinh24h.vn/resource/701101/assets/./images/signup-icon.png" /></span>
                                <a href="/create-account">Đăng ký</a>
                            </div>
                        </div>
                    </div> --}}
                    <!-- /currency -->
                        ...
                        <div class="tt-col-obj tt-obj-options">
                            ...
                            <div class="block-right">
                                ...
                                {{-- <div class="sign-up">
                                    <span><img
                                            src="//santaichinh24h.vn/resource/701101/assets/./images/signup-icon.png" /></span>
                                    <a href="/register_user">Đăng ký</a>
                                </div> --}}
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="flex-roww">
                    ...
                    <div class="d-flex d-sm-none text-center">
                        ...
                        {{-- <div class="sign-up">
                            <span><img
                                    src="//santaichinh24h.vn/resource/701101/assets/./images/signup-icon.png" /></span></br>
                            <a href="/create-account">Đăng ký</a>
                        </div> --}}
                    </div>
                    <div class="tt-col-obj tt-obj-logo">
    ...
    <div class="py-4 border">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-title">ĐĂNG KÝ TÀI KHOẢN</div>
                    <div class="border mt-2 mb-2">
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                <form class="py-4" action="{{'register'}}" method="post" id="createnew_account">
                                    @csrf
                                    <table class="table table-create border">
                                        <thead class="thead-light">
                                            <tr>
                                                <th colspan="3" class="text-center">ĐĂNG KÝ TÀI KHOẢN MỚI</th>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="d-flex align-items-center  required-field">
                                                <td class="col-md-4">Tên tài khoản</td>
                                                <td class="col-md-8"><input type="text" name="username"
                                                        class="form-control"
                                                        placeholder="Dùng SĐT chính để khách hàng đăng nhập" required>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="d-flex align-items-center">
                                                <td class="col-md-4">Xác nhận mật khẩu</td>
                                                <td class="col-md-8">
                                    ...
                                    <div class="mt-3">
                                        <table class="table table-create border">
                                            <thead class="thead-light">
                                                <tr>
                                                    <th colspan="3" class="text-center">THÔNG TIN CÁ NHÂN</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr class="d-flex align-items-center">
                                                    <td class="col-md-4">Họ và tên</td>
                                                    <td class="col-md-8"><input type="text" name="name"
                                                            class="form-control"
                                                            placeholder="Họ tên thật để giao dịch với KH trên sàn"
                                                            required></td>
                                                </tr>
                                                <tr class="d-flex align-items-center required-field">
                                                    ...
                                                    <td class="col-md-8">
                                                        <input type="email" name="email_account" class="form-control"
                                                            placeholder="Email để nhận thông tin giao dịch">
                                                    </td>
                                                </tr>
                                                <tr class="d-flex align-items-center">
                                                    <td class="col-md-4">Số điện thoại</td>
                                                    <td class="col-md-8"><input type="text" name="phone"
                                                            placeholder="phone" class="form-control"></td>
                                                </tr>
                                                <tr class="d-flex align-items-center">
                                                    <td class="col-md-4">Địa chỉ</td>
                                                    <td class="col-md-8"><input type="text" name="address"
                                                            placeholder="Địa chỉ hiện tại" class="form-control"></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <div class="input-div one">
                                                            <input type="radio" id="nam" name="gender" value="2">
                                                            <label for="html">Nam</label><br>
                                                            <input type="radio" id="nu" name="gender" value="1">
                                                            <label for="css">Nữ</label><br>
                                                            <input type="radio" id="khac" name="gender" value="3">
                                        ...
                                        <div class="text-center">
                                            <div class="item">
                                                ...
                                                <button class="btn btn-primary font-weight-bold" type="submit">Đăng ký
                                                </button>
                                            </div>
                                        </div>
                                    </div>
