...
<head>
    ...
    <meta property='og:url' content='http://santaichinh24h.vn/post-loan/-274' />
...
<!--Start of Tawk.to Script-->
<!--<script type="text/javascript"> liên kết API theo dõi user
...
<body>
    ...
    <header class="blockk_header" data-section-id="header">
        ...
        <nav class="panel-menu mobile-main-menu">
            <ul class="block-center">
                <li class="profile"><a href="/ho_so_ung_vien">Hồ sơ ứng viên</a></li>
                            ...
                            <div class="block-right">
                                <div class="logined d-flex">
                                    <div class="dropdown">
                                        <a class="text-primary dropdown-toggle" href="#" role="button"
                                            id="dropdownMenuInfo" data-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false">Duy</a>

                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuInfo">
                                            <a class="dropdown-item" href="/account/change-password">Đổi mật khẩu</a>
    ...
    <div class="block-footer-info text-center">
        <div class="d-flex justify-content-center">
            ...
            <div class="block-btn"><a href="#bangtinhlaixuat"><i class="fa fa-calculator" aria-hidden="true"></i></br>
                    Bảng tính lãi xuất</a></div>
            <div class="block-btn"><a href="/post-recruitment-create"><i class="fa fa-users" aria-hidden="true"></i>
                    </br> Đăng tin tuyển dụng</a></div>
            <div class="block-btn"><a href="/candidates"><i class="fa fa-address-card" aria-hidden="true"></i> </br> Hồ
                    sơ ứng viên</a></div>
    ...
    <div class="shadow">
        <div class="tt-breadcrumb">
            <div class="container">
                <ul>
                    ...
                    <li><a href="javascript:void(0)">HỖ TRỢ VAY TRẢ GÓP </a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="py-2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="table-title">THÔNG TIN CHO VAY</div>
                        <div class="border">
                            <div class="bg-white py-2 px-4">
                                <h1 class="text-danger font-weight-bold h5">HỖ TRỢ VAY TRẢ GÓP </h1>
                                <div class="widget-info d-flex align-items-center font-weight-bold mb-3">
                                    <div class="wrr">
                                        <span class="text-white">
                                            <i class="fa fa-eye"></i>
                                        </span>
                                    </div>
                                    <div class="wrs"><span>24/12/2021</span></div>
                                    <div class="wrs">
                                        <span>/
                                            <a href="/"></a>
                                        </span>
                                ...
                                <div class="bg-white py-3">
                                    <div class="border border-warning p-2 position-relative">
                                        <div class="text-warning font-weight-bold h5 text-info-contact">Nội dung
                                        </div>
                                        <div class="p-3">
                                            <div>Vay mua sắm, tiêu dùng từ 5- 50 triệu</div>

                                            <div>Lãi xuất 0,9%/ tháng&nbsp;</div>
                                ...
                                <div class="bg-white py-3 mt-3">
                                    <div class="border border-warning p-2 position-relative">
                                        <div class="text-warning font-weight-bold h5 text-info-contact">Thông tin liên
                                            hệ
                                        </div>
                                        <div class="p-3">
                                            {{auth()->user()->name}}
                                        </div>
                                        <div class="p-3">Liên hệ zalo qua : 
                                            {{auth()->user()->phone}}
                                        </div>
                                        <div class="p-3">
                                            {{auth()->user()->email}}
                        ...
                        <div class="d-block mt-2">
                            <table class="table border">
                                <thead class="thead-light">
                                    <tr>
                                        <th colspan="3" class="text-center">THÔNG CHO VAY LIÊN QUAN</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                    ...
                    <div class="col-lg-4">
                        <div class="related-records border contructor-ys d-none d-sm-block">
                            <div class="titlle text-center">THÔNG TIN NGƯỜI ĐĂNG</div>
                            <div class="side-barr">
                                <div class="record-item border-bottom pb-2 d-flex align-items-center">
                                    ...
                                    <div class="content-item w-100">
                                        ...
                                        <div class="level font-weight-bold">
                                            <a href="tel:0788788627" class="text-danger">
                                ...
                                <a href="/chung-khoan-giam-manh-vn-index-mat-44-diem">
                                    <div class="card card-news border-0 ">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <h4 class="card-title text-center text-md-left">Chứng khoán giảm mạnh,
                                                VN-Index mất 44 điểm</h4>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="/khong-gian-song-sang-theo-chuan-quoc-te-tai-lumiere-riverside">
                                    <div class="card card-news border-0 ">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <h4 class="card-title text-center text-md-left">Không gian sống sang theo
                                                chuẩn quốc tế tại Lumière riverside</h4>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="/xe-tu-lai-cua-apple-se-tao-ap-luc-lon-len-tesla-va-cac-doi-thu">
                                    <div class="card card-news border-0 ">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <h4 class="card-title text-center text-md-left">Xe tự lái của Apple sẽ tạo
                                                áp lực lớn lên Tesla và các đối thủ</h4>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="/gia-ve-may-bay-tet-2021-nhich-tang-tro-lai">
                                    <div class="card card-news border-0 ">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <h4 class="card-title text-center text-md-left">Giá vé máy bay Tết 2021
                                                nhích tăng trở lại</h4>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="/galaxy-s22-ultra-thua-iphone-13-pro-max-ve-thoi-luong-pin">
                                    <div class="card card-news border-0 ">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <h4 class="card-title text-center text-md-left">Galaxy S22 Ultra thua iPhone
                                                13 Pro Max về thời lượng pin</h4>
                                        </div>
                                    </div>
                                </a>
                            </div>
            ...
            <div class="py-3"
                                ...
                                <div class="contact-footinfo">
                                    <address>
                                        <div class="d-flex align-items-center">
                                            <div class="mr-3"><i class="fa fa-phone-square" aria-hidden="true"></i>
                                            </div>
                                    ...
                                    <address>
                                        <div class="d-flex align-items-center">
                                            <div class="mr-2"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
                ...
                <div class="container address-footer">
                    <div class="wrapp py-4">
                        ...
                        <div class="office"><a href="#">Văn phòng: Văn phòng: Tầng 17, Tòa nhà VIT, 519 Kim Mã, Quận Ba
                                Đình, Hà Nội.</a></div>
                    </div>
                </div>
            </div>
        ...
        <script
            src="//santaichinh24h.vn/resource/701101/assets/external/rs-plugin/js/jquery.themepunch.revolution.min.js">
        </script>
...
<script src="//santaichinh24h.vn/resource/701101/assets/external/countdown/jquery.countdown.min.js"></script> -->
    ...
    bkLib.onDomLoaded(function() {
        ...
        <div class="vcard" style="display:none">
            <img style="float:left; margin-right:4px" src="//santaichinh24h.vn/files/images/logo/logo-ff.png"
