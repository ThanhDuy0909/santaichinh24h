...
<head>
    ...
    <meta property='og:url' content='http://santaichinh24h.vn/post-loan-create' />
...
<body>
    ...
    <div class="block-footer-info text-center">
        <div class="d-flex justify-content-center">
            ...
            <div class="block-btn"><a href="/candidates"><i class="fa fa-address-card" aria-hidden="true"></i>
    ...
    <div class="py-4 border">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="table-title rounded">ĐĂNG TIN CHO VAY</div>
                    <div class="border mt-2 mb-2">
                        <div class="py-2 px-2 border-0 text-danger text-center">
                            Mẹo. Để đăng tin luôn được thấy đầu tiên => Vào <a href="javascript:void(0)"
                                class="text-primary">Cập nhật</a> lại tin
                            thường xuyên nhé
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" id="post_loan_news" class="py-4 px-3">
                                    <div class="form-group row">
                                        <label for="post_title" class="col-md-2 col-form-label">Tiêu đề *</label>
                                        <div class="col-md-10">
                                        ...
                                        <div class="col-md-10">
                                            <div class="border rounded py-3 px-3">
                                                <div class="form-group">
                                                    <label for="list_category_id" class="col-form-label">Data theo
                                                        loại</label>
                                                    <div>
                                                        <select class="custom-select select2" id="list_category_id"
                                                            name="list_category_id[]" multiple required>
                                                            <option value="">-- Chọn loại tin --</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="list_category_province_id" class="col-form-label">Tỉnh
                                                        thành</label>
                                                    <div>
                                                        <select class="custom-select select2"
                                                            id="list_category_province_id"
                                                            name="list_category_province_id[]" multiple required>
                                                ...
                                                <div class="form-group">
                                                    <label for="post_detail" class="col-form-label">Nội dung chi
                                                        tiết</label>
                                                    <div>
                                                        <textarea id="post_detail" name="entity_attribute[content]" style="width:100%;height:200px;"required></textarea>
                                                        {{-- <script type="text/javascript">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 col-form-label">Liên hệ *</label>
                                        <div class="col-md-10">
                                            <div class="border rounded py-3 px-3">
                                                <div class="form-group">
                                                    <label for="contact_info" class="col-form-label">Thông tin liên
                                                        hệ</label>
                                                    <div>
                                                        <textarea class="form-control" id="contact_info" rows="6" placeholder="Các thông tin liên hệ &#10; - Tên Công Ty (nếu có) &#10; - Tên người liên hệ &#10; - Số Điện thoại &#10; - Email &#10; - Địa chỉ"
                                                            name="entity_attribute[contact_info]" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="text-center mt-2">
                                                <button type="submit" name="action" value="PostAdd"
                                                    class="btn btn-primary bg-primary font-weight-bold text-white">
                                                    Đăng tin
                                                </button>
                                            </div>
                                        </div>
            ...
            <div class="row">
                            ...
                            <div class="item">
                                <a href="">
                                    <img src="//santaichinh24h.vn/files/images/logo/dt.png"
                                        alt="//santaichinh24h.vn/files/images/logo/dt.png" />
                                </a>
                            </div>
                            <div class="item">
                                <a href="">
                                    <img src="//santaichinh24h.vn/files/images/logo/dt2.png"
                                        alt="//santaichinh24h.vn/files/images/logo/dt2.png" />
                                </a>
                            </div>
                            <div class="item">
                                <a href="">
                                    <img src="//santaichinh24h.vn/files/images/logo/dt3.png"
                                        alt="//santaichinh24h.vn/files/images/logo/dt3.png" />
                                </a>
                            </div>
                            <div class="item">
                                <a href="">
                                    <img src="//santaichinh24h.vn/files/images/logo/dt4.png"
                                        alt="//santaichinh24h.vn/files/images/logo/dt4.png" />
                                </a>
                            </div>
                            <div class="item">
                                <a href="">
                                    <img src="//santaichinh24h.vn/files/images/logo/dt5.png"
                                        alt="//santaichinh24h.vn/files/images/logo/dt5.png" />
                                </a>
                            </div>
                            <div class="item">
                                <a href="">
                ...
                {{-- <div class="col-md-12">
                    ...
                    <div id="owl-news" class="owl-carousel owl-theme">
                        <div class="item">
                            <a href="/chung-khoan-giam-manh-vn-index-mat-44-diem">
                                <div class="card card-news border-0 ">
                                    <img class="card-img-top"
                                        src="//santaichinh24h.vn/files/images/tin-tuc-tai-chinh/Screenshot_5.jpg"
                                        alt="Chứng khoán giảm mạnh, VN-Index mất 44 điểm">
                                    <div class="card-body p-0">
                                        <div class="date-news font-weight-bold">
                                            08/02/2021
                                        </div>
                                        <h4 class="card-title text-center text-md-left">Chứng khoán giảm mạnh, VN-Index
                                            mất 44 điểm</h4>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="item">
                            <a href="/khong-gian-song-sang-theo-chuan-quoc-te-tai-lumiere-riverside">
                                <div class="card card-news border-0 ">
                                    <img class="card-img-top"
                                        src="//santaichinh24h.vn/files/images/tin-tuc-tai-chinh/image001_3.jpg"
                                        alt="Không gian sống sang theo chuẩn quốc tế tại Lumière riverside">
                                    <div class="card-body p-0">
                                        <div class="date-news font-weight-bold">
                                            08/02/2021
                                        </div>
                                        <h4 class="card-title text-center text-md-left">Không gian sống sang theo chuẩn
                                            quốc tế tại Lumière riverside</h4>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="item">
                            <a href="/xe-tu-lai-cua-apple-se-tao-ap-luc-lon-len-tesla-va-cac-doi-thu">
                                <div class="card card-news border-0 ">
                                    <img class="card-img-top"
                                        src="//santaichinh24h.vn/files/images/tin-tuc-tai-chinh/1.jpeg"
                                        alt="Xe tự lái của Apple sẽ tạo áp lực lớn lên Tesla và các đối thủ">
                                    <div class="card-body p-0">
                                        <div class="date-news font-weight-bold">
                                            08/02/2021
                                        </div>
                                        <h4 class="card-title text-center text-md-left">Xe tự lái của Apple sẽ tạo áp
                                            lực lớn lên Tesla và các đối thủ</h4>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="item">
                            <a href="/gia-ve-may-bay-tet-2021-nhich-tang-tro-lai">
                                <div class="card card-news border-0 ">
                                    <img class="card-img-top"
                                        src="//santaichinh24h.vn/files/images/tin-tuc-tai-chinh/tiepvien.jpg"
                                        alt="Giá vé máy bay Tết 2021 nhích tăng trở lại">
                                    <div class="card-body p-0">
                                        <div class="date-news font-weight-bold">
                                            08/02/2021
                                        </div>
                                        <h4 class="card-title text-center text-md-left">Giá vé máy bay Tết 2021 nhích
                                            tăng trở lại</h4>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="item">
                            <a href="/galaxy-s22-ultra-thua-iphone-13-pro-max-ve-thoi-luong-pin">
                                <div class="card card-news border-0 ">
                                    <img class="card-img-top" src="//santaichinh24h.vn/files/images/apple.jpeg"
                                        alt="Galaxy S22 Ultra thua iPhone 13 Pro Max về thời lượng pin">
                                    <div class="card-body p-0">
                                        <div class="date-news font-weight-bold">
                                            18/02/2022
                                        </div>
                                        <h4 class="card-title text-center text-md-left">Galaxy S22 Ultra thua iPhone 13
                                            Pro Max về thời lượng pin</h4>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="text-center pb-3">
                        <a href="/tin-tuc-tai-chinh-thi-truong" class="read-more">Xem thêm <i
