...
<head>
    ...
    <meta property='og:url' content='http://santaichinh24h.vn/post-loan-filter' />
            ...
            <div class="row">
                <div class="col-md-9">
                    <form id="search_employ" class="bg_employ mb-4">
                        <div class="form-row">
                            <div class="col-md-5">
                                <label for="inputGroupSelect02" class="col-form-label">Cho vay theo: </label>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="title-news" style="width: 50%">
                                            <a href="/post-loan/-274" title="HỖ TRỢ VAY TRẢ GÓP ">HỖ TRỢ VAY TRẢ GÓP
                                            </a>
                                            <p style="
                                                color: #daa600;
                                                font-weight: bold;
                                            ...
                                            <div class="text-center">
                                                <nav aria-label="Page navigation example ">
                                                    ...
                                                    <ul class="pagination justify-content-center tt-offset-20">
                                                        ...
                                                        <li class="page-item">
                                                            <a href="/post-loan-filter?page=2&amp;limit=25"
                                                                class="page-link" aria-label="Next">2</a>
                                                        </li>
                                                        <li class="page-item disabled">
                                                            <a class="page-link"
                                                                href="/post-loan-filter?page=2&amp;limit=25"
                                                                aria-label="Next">
                ...
                <div class="col-md-3">
                    <div class="mb-2">
                        <a class="buysell-data justify-content-between d-flex align-items-center"
                            href="/post_tinchovay"> Đăng Tin Cho Vay <i class="fa fa-usd"
