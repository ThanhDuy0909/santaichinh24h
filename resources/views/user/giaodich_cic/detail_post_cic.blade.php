...
<head>
    ...
    <meta property='og:url' content='http://santaichinh24h.vn/post-cic/-282' />
    ...
    <div class="shadow">
        <div class="tt-breadcrumb">
            <div class="container">
                <ul>
                    ...
                    <li><a href="javascript:void(0)">Thuê CIC</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="py-2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="table-title">THÔNG TIN CHECK CIC - THUÊ USER</div>
                        <div class="border">
                            <div class="bg-white py-2 px-4">
                                <h1 class="text-danger font-weight-bold h5">Thuê CIC</h1>
                                <div class="widget-info d-flex align-items-center font-weight-bold mb-3">
                                    ...
                                    <div class="wrs"><span>14/01/2022</span></div>
                                    <div class="wrs">
                                        <span>/
                                            <a href="/"></a>
                                        </span>
                        ...
                        <div class="d-block mt-2">
                            <table class="table border">
                                <thead class="thead-light">
                                    <tr>
                                        <th colspan="3" class="text-center">THÔNG TIN CHECK CIC - THUÊ USER LIÊN QUAN
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
