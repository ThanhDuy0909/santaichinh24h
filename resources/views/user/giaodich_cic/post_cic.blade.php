...
<head>
    ...
    <meta property='og:url' content='http://santaichinh24h.vn/post-cic-create' />
...
<body>
    ...
    <div class="py-4 border">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="table-title rounded">ĐĂNG TIN GIAO DỊCH CIC</div>
                    <div class="border mt-2 mb-2">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form id="cic_posting" method="post" class="py-4 px-3">
                                        ...
                                        <div class="col-md-10">
                                            <div class="border rounded py-3 px-3">
                                                <div class="form-group">
                                                    <label for="list_category_id" class="col-form-label">Loại hình cung
                                                        cấp</label>
                                                    <div>
                                                ...
                                                <div class="form-group">
                                                    <label for="post_detail" class="col-form-label">Nội dung chi tiết</label>
                                                    <div>
