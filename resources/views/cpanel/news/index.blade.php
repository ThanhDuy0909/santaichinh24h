...
<div class="page-content">
	...
	<div class="page-breadcrumbs breadcrumbs-fixed">
		...
		<div class="text-align-right text-align-left-xs col-xs-12 col-md-8">
			<div class="col-lg-12 col-sm-12 col-xs-12 titleSearchNews"></div>
		</div>
	</div>
	<!-- /Page Breadcrumb -->
	<!-- Page Body -->
	<div class="page-body">
		<div class="row">
			<div class="col-xs-12 col-md-12">
				<div class="widget">
					<div class="widget-header with-footer"> <span class="widget-caption titleNews"></span></div>
									...
									<div class="col-xs-12 col-md-6 text-align-right">
										<div id="simpledatatable_filter" class="dataTables_filter">
											<div class="input-group">
												<select class="inputSearchNews"></select>
											</div>
										</div>
									</div>
								</div>
